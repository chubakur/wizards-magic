...
water_cards_copy = water_cards[:]
fire_cards_copy = fire_cards[:]
air_cards_copy = air_cards[:]
earth_cards_copy = earth_cards[:]
life_cards_copy = life_cards[:]
death_cards_copy = death_cards[:]